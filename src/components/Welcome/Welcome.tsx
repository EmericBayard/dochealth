  ...
  return (
        <div className="Welcome">
            ...
            <div className="WelcomeContent">
                ...
                <div className="titleText"> <div className="underlineBlueText">Take care</div> of your body and it will take care of <div className="underlineBlueText">you.</div></div>
